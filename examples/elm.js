			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'font-size', _1: '55px'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'border', _1: '15px solid #bbada0'},
								_1: {
	...
	if (_p1.ctor === '[]') {
		...
		if (_p2.ctor === '[]') {
			...
			return _elm_lang$core$Native_Utils.eq(_p3, _p2._0) ? {
				ctor: '::',
				_0: 2 * _p3,
				_1: _user$project$Main$recMerge(_p2._1)
			} : {
				ctor: '::',
				_0: _p3,
				_1: _user$project$Main$recMerge(_p4)
			};
		}
	}
};
...
var _user$project$Main$mergeLeft = function (board) {
	var lst = _user$project$Main$recMerge(
		_user$project$Main$removeZeroes(board));
	return A2(
		_elm_lang$core$List$append,
		lst,
		A2(
			_elm_lang$core$List$repeat,
			4 - _elm_lang$core$List$length(lst),
			0));
};
	...
	while (true) {
		...
		if (_p5.ctor === '[]') {
			...
			if (_p5._0.ctor === '[]') {
				...
				var _p6 = _p5._1;
				var tails = A2(_elm_lang$core$List$filterMap, _elm_lang$core$List$tail, _p6);
				var heads = A2(_elm_lang$core$List$filterMap, _elm_lang$core$List$head, _p6);
				return {
					ctor: '::',
					_0: {ctor: '::', _0: _p5._0._0, _1: heads},
					_1: _user$project$Main$transpose(
						{ctor: '::', _0: _p5._0._1, _1: tails})
				};
			}
		}
	}
			...
			if (_p9.ctor === '[]') {
				...
				if (_elm_lang$core$Native_Utils.eq(_p10, 0)) {
					if (_elm_lang$core$Native_Utils.eq(n, 1)) {
						return {
							ctor: '_Tuple2',
							_0: {ctor: '::', _0: newTile, _1: _p11},
							_1: n - 1
						};
					} else {
						var rec = A3(_user$project$Main$recAddTile, n - 1, newTile, _p11);
						return {
							ctor: '_Tuple2',
							_0: {
								ctor: '::',
					...
					var rec = A3(_user$project$Main$recAddTile, n, newTile, _p11);
					return {
						ctor: '_Tuple2',
						_0: {
							ctor: '::',
...
var _user$project$Main$recAddTileRow = F3(
	function (lst, n, newTile) {
		...
		if (_p12.ctor === '[]') {
			...
			var _p13 = A3(_user$project$Main$recAddTile, n, newTile, _p12._0);
			var a = _p13._0;
			var b = _p13._1;
			return {
				ctor: '::',
				_0: a,
				_1: A3(_user$project$Main$recAddTileRow, _p12._1, b, newTile)
			};
		}
	});
var _user$project$Main$getNewTile = function (rand) {
	return (_elm_lang$core$Native_Utils.cmp(rand, 0.9) < 0) ? 2 : 4;
};
var _user$project$Main$numZeroes = function (_p14) {
...
var _user$project$Main$doDown = function (_p15) {
	return _user$project$Main$transpose(
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$mergeRight,
			_user$project$Main$transpose(_p15)));
};
var _user$project$Main$doUp = function (_p16) {
	return _user$project$Main$transpose(
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$mergeLeft,
			_user$project$Main$transpose(_p16)));
};
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'height', _1: '508px'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'width', _1: '500px'},
									_1: {
...
var _user$project$Main$AddTile = F2(
	function (a, b) {
		return {ctor: 'AddTile', _0: a, _1: b};
	});
var _user$project$Main$init = function () {
	var model = A2(
		_elm_lang$core$List$repeat,
		4,
		A2(_elm_lang$core$List$repeat, 4, 0));
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$Main$Model, false, model),
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				...
				_0: A2(
					...
					function (_p17) {
						var _p18 = _p17;
						return A2(_user$project$Main$AddTile, _p18._0, _p18._1);
					},
					A2(
						...
						A2(
							...
							1,
							_user$project$Main$numZeroes(model)),
				...
				_1: {
					...
					_0: A2(
						...
						function (_p19) {
							var _p20 = _p19;
							return A2(_user$project$Main$AddTile, _p20._0, _p20._1);
						},
						A2(
							_elm_lang$core$Random$pair,
							A2(
								_elm_lang$core$Random$int,
								1,
								_user$project$Main$numZeroes(model) - 1),
							A2(_elm_lang$core$Random$float, 0, 1))),
					_1: {ctor: '[]'}
				}
			})
			...
			case 'Move':
				...
				return model.gameOver ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : (_elm_lang$core$Native_Utils.eq(newModel, model.board) ? {
					...
					_1: A2(
						...
						function (_p23) {
							var _p24 = _p23;
							return A2(_user$project$Main$AddTile, _p24._0, _p24._1);
						},
						A2(
							_elm_lang$core$Random$pair,
							A2(
								_elm_lang$core$Random$int,
								1,
								_user$project$Main$numZeroes(newModel)),
							A2(_elm_lang$core$Random$float, 0, 1)))
				});
			case 'AddTile':
				var _p25 = _p21._0;
				if (_user$project$Main$checkGameOver(model.board)) {
					...
					var board = A3(
						_user$project$Main$recAddTileRow,
						model.board,
						A2(
							_elm_lang$core$Debug$log,
							_elm_lang$core$Basics$toString(_p25),
							_p25),
						_user$project$Main$getNewTile(_p21._1));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			_0: _elm_lang$keyboard$Keyboard$downs(
				function (_p27) {
					return _user$project$Main$Move(
						_user$project$Main$detectDir(_p27));
				}),
			_1: {ctor: '[]'}
		});
};
